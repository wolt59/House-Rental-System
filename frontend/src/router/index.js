    ...
    children: [
      ...
      { path: 'notifications', name: 'Notifications', component: () => import('../views/common/Notifications.vue') },
      {
        ...
        children: [
          ...
          { path: 'contract/:id', name: 'TenantContractDetail', component: () => import('../views/tenant/ContractDetail.vue') },
          { path: 'contract/:id/sign', name: 'TenantContractSign', component: () => import('../views/tenant/ContractSign.vue') },
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'contract/:id', name: 'LandlordContractDetail', component: () => import('../views/landlord/ContractDetail.vue') },
          { path: 'contract/:id/edit', name: 'ContractEdit', component: () => import('../views/landlord/ContractEdit.vue') },
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'contracts', name: 'AdminContracts', component: () => import('../views/admin/AdminContracts.vue') },
          { path: 'bookings', name: 'AdminBookings', component: () => import('../views/admin/AdminBookings.vue') },
          { path: 'maintenance', name: 'AdminMaintenance', component: () => import('../views/admin/AdminMaintenance.vue') },
          { path: 'complaints', name: 'AdminComplaints', component: () => import('../views/admin/AdminComplaints.vue') },
